...
public class BonjourService : NSObject {
    ...
    public init(type: String, port: UInt16 = 0, name: String) {
        self.type = type
        self.name = name
        self.port = port
    }
    ...
    public func start() {
        ...
        do {
            ...
            let service = NetService(domain: "local.", type: type, name: name, port: Int32(hostSocket.localPort))
